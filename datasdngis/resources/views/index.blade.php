...
<body class="min-h-screen flex flex-col bg-white">
    ...
    <div class="relative h-[500px] overflow-hidden bg-gray-700">
        <img src="images/semarang-skyline.jpg" alt="Semarang Skyline" class="absolute w-full h-full object-cover opacity-60">
        <!-- Overlay gelap -->
        ...
        <div class="max-w-7xl mx-auto bg-tableBlue rounded-lg shadow-sm">
            ...
            <div class="overflow-x-auto">
                ...
                <div class="divide-y divide-gray-100">
                    <div class="grid grid-cols-custom gap-8 p-4 bg-white items-start">
                        <div class="text-sm pl-2">1.</div>
                        <div>
                            <a href="#" class="text-blue-500 hover:underline font-medium">SDN Bandarharjo01</a>
                        ...
                        <div class="flex flex-col items-end pr-16">
                            <div class="text-gray-600 text-sm">-6.987654, 110.423456</div>
                            <a href="https://www.google.com/maps?q=-6.987654,110.423456" target="_blank" 
                        ...
                        <div class="flex justify-center">
                            <div class="border border-gray-200 rounded-lg p-1">
                                <img src="images/mudik.jpg" alt="SDN Bandarharjo01" class="w-[120px] h-[80px] rounded-lg object-cover">
                            </div>
                        </div>
                    </div>

                    <div class="grid grid-cols-custom gap-8 p-4 bg-white items-start">
                        <div class="text-sm pl-2">2.</div>
                        <div>
                            <a href="#" class="text-blue-500 hover:underline font-medium">SDN Bandarharjo02</a>
                            <div class="text-gray-600 mt-1 text-sm leading-relaxed">
                                Jl. Cumi-Cumi Raya No.2,<br>
                                Bandarharjo, Kec. Semarang Utara,<br>
                                Kota Semarang, Jawa Tengah<br>
                        ...
                        <div class="flex justify-center">
                            <div class="border border-gray-200 rounded-lg p-1">
                                <img src="images/mudik.jpg" alt="SDN Bandarharjo02" class="w-[120px] h-[80px] rounded-lg object-cover">
                            </div>
                        </div>
                    </div>
                </div>
